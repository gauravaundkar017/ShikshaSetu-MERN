...
const AdminDashboard = () => {
  ...
  // Fetching the courses data from Redux toolkit store
  ...
  const handleCourseDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete the course?")) {
      ...
      // Fetching the updated data for the course
  ...
  //     setTimeout(() => {
  //       console.log("Courses Data after dispatch:", myCourses);
  //     }, 1000); // Delay to wait for state update
  //   })();
  // }, [dispatch]);
...
//   // Log the state of all the users and subscriptions
//   console.log("All Users Count: ", allUsersCount);
//   console.log("Subscribed Users Count: ", subscribedUsersCount);
...
//   console.log("Courses Data: ", myCourses);
